...
max_gen = 2 # number of tokens to generate, multiplied by 1000
...
ckpt_paths = sorted(glob.glob(f'{out_dir}/ckpt_iter*.pt'), key=extract_number)

for ckpt in ckpt_paths:
    # model
    if init_from == 'resume':
        output_file = f'iter{extract_number(ckpt)}.txt'
